...
{
	public class EntityDaoCodeGenerator : CodeGenerator
	{
		private Dictionary<string, string> fieldSnippets = new Dictionary<string, string>();

		public override string GetFileName()
		{
			return this.BaseEntity.EntityName + "DAO.cs";
		}
		...
		{
			this.fieldSnippets.Add("string", ExtractSnippet("/*BEGIN_FILTER_TEMPLATE_STRING_ANYWHERE*/", "/*END_FILTER_TEMPLATE_STRING_ANYWHERE*/"));
